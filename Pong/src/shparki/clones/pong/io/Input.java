package shparki.clones.pong.io;
...
public class Input implements KeyListener{
	...
	public void keyPressed(KeyEvent e) {
		if (!isKeyDown(e.getKeyCode())){
			if (!isKeyPressed(e.getKeyCode())) keysPressed.add(Integer.valueOf(e.getKeyCode()));
			keysDown.add(Integer.valueOf(e.getKeyCode()));
		}
	}
	public void keyReleased(KeyEvent e) {
		if (isKeyDown(e.getKeyCode())){
			if (!isKeyReleased(e.getKeyCode())) keysReleased.add(Integer.valueOf(e.getKeyCode()));
